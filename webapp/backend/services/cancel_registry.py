...
_TRACKERS: dict[str, "ProgressTracker"] = {}  # type: ignore[name-defined]


def register(batch_id: str, tracker) -> None:
...
def get_tracker(batch_id: str) -> Optional["ProgressTracker"]:  # type: ignore[name-defined]
    with _LOCK:
